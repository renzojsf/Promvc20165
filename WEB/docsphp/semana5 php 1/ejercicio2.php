...
<link rel="stylesheet" href="../../semana 5 php/semana5 php 1/mm_restaurant1.css" type="text/css" />
</head>
<body bgcolor="#0066cc">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr bgcolor="#ffffff">
	<td width="15" valign="top"><img src="../../semana 5 php/semana5 php 1/mm_spacer.gif" alt="" width="15" height="1" border="0" /></td>
	<td width="140" valign="top"><img src="../../semana 5 php/semana5 php 1/mm_spacer.gif" alt="" width="140" height="1" border="0" /></td>
...
{
	if ($op=='F'){
		include("../../semana 5 php/semana5 php 1/factorial.inc.php");
	}
	else
	{
		include("../../semana 5 php/semana5 php 1/divisores.inc.php");
	}
}
?>
