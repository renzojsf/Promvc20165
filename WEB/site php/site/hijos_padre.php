     ...
     <tr>
      <td align="center">
       <table border="0" width="700px" align="center" cellpadding="0" cellspacing="0" style="font-family:verdana;font-size:12px">
        <tr height="25px"><td width="100px" style="text-indent:15px">Padre</td><td><? echo $vector_['apellidos'].', '.$vector_['nombres']; ?></td><td width="65px" align="left"><input type="button" value="Atras" onclick="javascript:document.location.href='principal.php?sis=<?=$_REQUEST['sis']?>&ven=<?=$_REQUEST['ven']?>&pag=8&ref=<?=$id_p?>';" style="cursor:pointer;font-family:verdana;font-size:12px"></td></tr>
        <tr height="25px"><td width="100px" style="text-indent:15px">Direccion</td><td><?=$vector_['direccion']?>&nbsp;&nbsp;-&nbsp;&nbsp;Tlf <?=$vector_['telefono']?></td></tr>
                <tr height="25px"><td width="100px" style="text-indent:15px">Ocupacion</td><td><?=$vector_['ocupacion']?></td></tr>
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="border:solid 1px #7f7f7f;font-size:12px;font-family:verdana;text-shadow:-1px -1px white, 1px 1px #999;color:#333">
			...
			<td align="left" style="text-indent:10px" class="cabeza">Nombre del hijo</td>
			<td align="center" width="90px" class="cabeza">Telefono</td>
			<td align="center" width="90px" class="cabeza">F Nacimiento</td>
			</tr>
		</table>
		</td>
		</tr>
                 ...
                 $consulta = "call sp_relacion_hijos($id_p,0,0);";
                 ...
                 $con = new conexion();
                 $consulta = "call sp_relacion_hijos($id_p,$inicio,$resultados);";
                 $respuesta = $con->consulta($consulta);
                ...
                <tr>
                 <td style="background-color:#<? echo $color; ?>">
                  <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="border:dashed 1px #A4A4A4;font-size:12px;font-family:verdana">
                   <tr height="30px">
            <td width="25px" align="center"><img src="img/alumno<?=$vector['sexo']?>.png"></td>
                    <td align="left" style="text-indent:15px"><?=$vector['alumno']?></td>
		    <td align="center" width="90px"><?=$vector['telefono']?></td>
                ...
                <? } if($numero==0){ ?><tr><td style="color:#060" align="center">No hay ningun alumno registrado como hijo de este padre.</td></tr><? } ?>
                <? if ($total_paginas > 1){ ?>
