...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="560">
		<tr>
		<td class="pageName"><p>CONTADOR DE VISITAS </p></td>
		</tr>
...
//haciendo el contador de visitas
if($puntero=fopen("visitas.txt","r")){//numero actual
$visitas=fgets($puntero,7);
//siete para que jale 6 
$visitas++;
//cierra archivo
fclose($puntero);
}
echo"<h2>Visita Nro; $visitas</h2>";
//aha aqui solo graba 1 por maquina
if($puntero=fopen("visitas.txt","w")){
fputs($puntero,$visitas);//fwrite()
fclose($puntero);
}
echo"<h2>Visita Nro: $visitas</h2>";
